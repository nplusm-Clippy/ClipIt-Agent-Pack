...
Use with `clipit-operator`. Read [references/project-structure.md](references/project-structure.md) before creating or reorganizing a project, and load timeline-editing before changing placements.
