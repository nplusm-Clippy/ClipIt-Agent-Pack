...
Use with `clipit-operator`. Read [references/creator-profile.md](references/creator-profile.md) before inferring, writing, or applying persistent preferences.
...
- [references/creator-profile.md](references/creator-profile.md)
