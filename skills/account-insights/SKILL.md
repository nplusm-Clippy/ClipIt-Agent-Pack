...
|-----------|----------------|---------------|
| Check credits/usage | `clipit credits balance|usage --json` | `scripts/get_credits_balance.py` |
| Preflight cost/cap | `clipit credits estimate ... --json` or paid command `--max-credits` | `scripts/estimate_cost.py ... --max-credits <n>` |
...
2. Run `scripts/estimate_cost.py` with metrics as `key=value` pairs and the approved `--max-credits` cap when one exists
...
- [scripts/estimate_cost.py](scripts/estimate_cost.py)
- [scripts/get_analytics_overview.py](scripts/get_analytics_overview.py)
- [scripts/get_credits_balance.py](scripts/get_credits_balance.py)
- [scripts/get_post_metrics.py](scripts/get_post_metrics.py)
- [scripts/get_top_clips.py](scripts/get_top_clips.py)
